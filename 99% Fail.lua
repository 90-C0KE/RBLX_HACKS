...
local Window = Library.CreateLib("99% Fail", "Sentinel")
local MainTab = Window:NewTab("Main")
local MainSection = MainTab:NewSection("MainSection")

MainSection:NewButton("Infinite Yield", "Load Infinite Yield, a powerful admin tool.", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source"))()
end)

MainSection:NewButton("Tile Memory", "Make tiles red or green based on player interections.", function()
	--// Services \\--
